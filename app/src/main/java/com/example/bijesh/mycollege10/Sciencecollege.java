 ...
 */
public class Sciencecollege extends FragmentActivity{
    ...
    AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
        ...
        protected String doInBackground(Void... params) {
            String data = http.HTTPGetData("http://192.168.164.1/mycollege/sciencefaculty.php");
            return data;
        }
     ...
     /* collegelistnew.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				*//*Toast.makeText(
                ...
                Intent newIntent =new Intent(getApplicationContext(),Sciencedetails.class);
